...
exports.highlight = function (text, language, style) {
  if (language) {
    var $ = cheerio.load(exports.escapeCurlies(hljs.highlight(language, text, true).value)); // Assumes hljs output doesn't use curlies
    ...
    return exports.escapeCurlies(text);
  }
};
