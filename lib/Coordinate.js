...
Coordinate.prototype.lte = function (other) {
  return this.x <= other.x && this.y <= other.y;
};
Coordinate.prototype.lt = function (other) {
  return this.x < other.x && this.y < other.y;
};
Coordinate.prototype.within = function (cornerOne, cornerTwo) {
  var topLeft = Coordinate.min(cornerOne, cornerTwo);
  var bottomRight = Coordinate.max(cornerOne, cornerTwo);
  return topLeft.lte(this) && this.lt(bottomRight);
};
