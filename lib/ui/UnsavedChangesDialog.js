...
function UnsavedChangesDialog (opts) {
  ...
  var saveChangesButtonRight = self.padding.right + util.shrinkWidth(self.cancelButton) + 1;
  ...
  var quitAnywayButtonRight = saveChangesButtonRight + util.shrinkWidth(self.saveChangesButton) + 1;
