...
Header.prototype._initHandlers = function () {
  ...
  self.helpButton.on('press', function () { self.slap.helpDialog.show(); });
...
Header.prototype.render = function () {
  ...
  var editor = (self.slap.currentPane() || {}).editor;
  if (editor) {
    ...
    if (!self.slap.insertMode()) right.unshift(markup('OVR', style.overwrite));
