...
Slap.prototype._initBlink = function () {
  var self = this;
...
Slap.prototype._initHandlers = function () {
  ...
  ['resize', 'message', 'save', 'path'].forEach(function (evt) {
...
Slap.prototype.render = function () {
  ...
  if (message) {
    if (self.data.blink) { message = markup.markupLine(message, style.blink); }
